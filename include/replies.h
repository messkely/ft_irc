...
#define RPL_TOPIC(prefix, channel, topic, nick) 		    prefix + " 332 " + nick + " " + channel + " :" + topic + LF
#define RPL_NOTOPIC(channel, nick) 						    PREFIX + std::string("331 ") + nick + " " + channel + " :No topic is set" + LF
...
#define RPL_CHANNELMODEIS(nick, channelname, mode, params)  PREFIX "324 " + nick + " " + channelname + " " + mode + " " + params + LF
